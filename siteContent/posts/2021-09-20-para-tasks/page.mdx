...
The app is [hosted on github](https://scottyob.github.io/paragliding-task-checker/)

Source code:  [https://github.com/scottyob/paragliding-task-checker](https://github.com/scottyob/paragliding-task-checker)
