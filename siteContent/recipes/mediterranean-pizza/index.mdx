...
<div className="flex">
<Image alt="Before running food processor" src={before.src} width={300} height={300} />
<Image alt="Baba Ganoush After Food Processor" src={after.src} width={300} height={300} />
</div>
